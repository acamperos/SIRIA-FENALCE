...
<fieldset>
    ...
    <s:form id="formProfile" action="saveProfile.action">
        ...
        <div class="row">
            ...
            <% if (true) { %>
                <div class="col-md-12">
                    <sj:submit type="button" cssClass="btn btn-initial btn-lg" onclick="addMessageProcess()" targets="divMessage" onCompleteTopics="completeProfile" validate="true" validateFunction="validationForm"><i class="icon-save"></i>  <s:property value="getText('button.saveprofile.profile')" /></sj:submit>
                </div>  
            <% } %>
        </div>  
        <script>
