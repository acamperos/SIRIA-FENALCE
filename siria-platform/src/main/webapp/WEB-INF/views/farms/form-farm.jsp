                ...
                <s:form id="formFarm" action="saveFarm.action" cssClass="form-horizontal formClassProperty">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls col-md-6">
                                <s:textfield cssClass="form-control" id="formFarm_latitude_property" name="latitude_property" onkeyup="generateDegrees('formFarm_latitude_property', 'formFarm_latitude_degrees_property', 'formFarm_latitude_minutes_property', 'formFarm_latitude_seconds_property')"/>
                            </div>
                        </div>
                        <div class="form-group">
