...
{    
    ...
    public Sowing objectById(Integer id) {
        ...
        sql += " p.dose_unit_sow,p.cost_sow,p.cost_seed_sow,p.comment_sow ,p.germination_percentage_sow,p.prefertilizer_sow,p.status, p.created_by, g.id_gen, g.name_gen, g.code_gen, g.status_gen, g.crop_type_gen, g.country_gen"; 
        sql += " from sowing p";
