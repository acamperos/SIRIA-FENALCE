...
{    
    ...
    public PhysiologicalMonitoring objectById(Integer id) {
        ...
        sql += " p.20_days_population_mon_fis, p.ini_primor_phy_mon, p.flowering_date_uno,p.flowering_date_cinco,p.flowering_date_phy_mon, p.percentage_reseeding_phy_mon, p.comment_phy_mon,p.status, p.created_by";
