...
<tr value="<%= numRows %>" id="RowAddit_<%= numRows %>">
    ...
    <td style="vertical-align: bottom ! important; padding: 0 3em;">
        <div style="margin-bottom:1.2em">
            ...
            <a class="btn btn-small delete_rows_dt btn-delete" title="<s:property value="getText('link.remove.soil')" />" onclick="removeRowHorizon('RowAddit_<%= numRows %>', 'tableAdit');"><i class="icon-trash"></i></a>
        </div>
    </td>
</tr>