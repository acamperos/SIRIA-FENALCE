            ...
            <fieldset>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <th><s:property value="getText('td.producername.report')" /></th>
                            ...
                            <tr>
                                <th><s:property value="getText('td.department.report')" /></th>
                            ...
                            <tr>
                                <th><s:property value="getText('td.communename.report')" /></th>
                            ...
                            <tr>
                                <th><s:property value="getText('td.latitude.report')" /></th>
